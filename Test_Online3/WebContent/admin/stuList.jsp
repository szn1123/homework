...
<body>
	...
	<a   href="javascript:void(0)" onclick="location.href='student.action?action=addstu';">添加学生</a> <br/>  
	<a   href="javascript:void(0)" onclick="location.href='student.action?action=backmain';">返回</a> <br/>
</body>
</html>